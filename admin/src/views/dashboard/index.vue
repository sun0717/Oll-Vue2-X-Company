  ...
  <div class="welcome">
    <el-row>
      <el-card>
        <el-row>
          <el-col :span="3">
            <el-avatar :size="100" :src="basicInfo.avatar" fit="scale-down" />
          </el-col>
          <el-col :span="16">
            <h3>{{ getTimeState().before }} {{ basicInfo.accountName }} ，{{ getTimeState().after }} </h3>
            <p>{{ basicInfo.description }}</p>
          </el-col>
          <!-- <el-col v-if="!flag" :span="4">
            <div class="wxQr">
              <h4>扫码关注公众号</h4>
              <el-image style="width: 100px; height: 100px" :src="weixinQr" contain />
            </div>
          </el-col> -->
        </el-row>
      </el-card>
      ...
      <el-card>
        ...
        <el-carousel :interval="4000" type="card">
          <el-carousel-item v-for="(item, index) in productData" :key="index">
            <el-image :src="item.bgImg" fit="cover" />
          </el-carousel-item>
        </el-carousel>
      </el-card>
    </el-row>
    <el-row v-if="flag" class="tongji">
      <el-card>
        <el-col :span="12">
          <h3>用户注册量统计</h3>
          <div id="registerChart" ref="registerChart" style="width:500px;height:300px" />
        </el-col>
        <el-col :span="12">
          <h3>访问量统计</h3>
          <div id="fwChart" ref="fwChart" style="width:500px;height:300px" />
        </el-col>
      </el-card>
    </el-row>
  </div>
